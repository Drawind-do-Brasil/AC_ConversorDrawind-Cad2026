...
namespace ConversorDrawind.UI.Wpf.Main
{
    public partial class ConverterEditorWorkspace : UserControl
    {
        ...
        public TextBox ScaleManualP1XTextBox => ScaleTab.P1XTextBoxControl;
        public TextBox ScaleManualP1YTextBox => ScaleTab.P1YTextBoxControl;
        public TextBox ScaleManualP1ZTextBox => ScaleTab.P1ZTextBoxControl;
        public TextBox ScaleManualP2XTextBox => ScaleTab.P2XTextBoxControl;
        public TextBox ScaleManualP2YTextBox => ScaleTab.P2YTextBoxControl;
        public TextBox ScaleManualP2ZTextBox => ScaleTab.P2ZTextBoxControl;
        public TextBox ScaleAutoP1XTextBox => ScaleTab.AP1XTextBoxControl;
        public TextBox ScaleAutoP1YTextBox => ScaleTab.AP1YTextBoxControl;
        public TextBox ScaleAutoP1ZTextBox => ScaleTab.AP1ZTextBoxControl;
        public TextBox ScaleAutoP2XTextBox => ScaleTab.AP2XTextBoxControl;
        public TextBox ScaleAutoP2YTextBox => ScaleTab.AP2YTextBoxControl;
        public TextBox ScaleAutoP2ZTextBox => ScaleTab.AP2ZTextBoxControl;
