...
public sealed class ConfigurationCharacterizationTests
{
    ...
    private static string Snapshot()
    {
        var lines = new List<string>
        {
            ...
            "EXTSCALEMp1=" + Point(Configuration.Config.EXTSCALEMp1),
            "EXTSCALEMp2=" + Point(Configuration.Config.EXTSCALEMp2),
            "EXTSCALEAp1=" + Point(Configuration.Config.EXTSCALEAp1),
            "EXTSCALEAp2=" + Point(Configuration.Config.EXTSCALEAp2),
